...
def page_two(scr1):
    ...
    b.place(x=300,y=100)
    backs=PhotoImage(file="C:\\Users\\pc\\Desktop\\abc.gif")
    c.create_image(350,172,image=backs)
    lab=Label(mainf2,text= "Created by Nitesh Kumar Sharma",fg="red",font=('Times New Roman',20,'bold'),bg='sky blue')
...
def main():
    ...
    back=PhotoImage(file="C:\\Users\\pc\\Desktop\\abc.gif")
...
def result(scr,p,ne,n):
    ...
    c.pack()
    img=ImageTk.PhotoImage(Image.open("E://smiley.jpg"),width=900)
